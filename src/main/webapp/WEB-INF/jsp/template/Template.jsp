...
<html lang="en"><head>
        ...
        <script src="${pageContext.request.contextPath}/resources/lib/jquery-1.11.1.min.js" type="text/javascript"></script>

        <script src="${pageContext.request.contextPath}/resources/lib/jQuery-Knob/js/jquery.knob.js" type="text/javascript"></script>
